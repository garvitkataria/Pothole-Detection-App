...
Date:string;
  ...
  UploadImage(){
  	let url = "http://10.0.38.184:8000/potholes/view/";
  	let postData = new FormData();
    var blob = new Blob([this.base64Image], { "type": "image/jpg" });
  	postData.append('img',blob)
  	postData.append('danger_level',"10")
  	postData.append('user_feedback',"Hello World")
  	postData.append('point',"30.9999, 80.111111")
